...
object CatsIntro {
  ...
  // eq
  // val aComparation = 2 == "a string" -- wrong, will trigger a compiler warning, will always returns false
  ...
  // part 5 - extending the TC operatons to composite types, e.g: List
